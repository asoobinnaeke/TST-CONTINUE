  ...
  },
  {
    ...
    qs: [
      { q: "What is Multi Trader?",
        a: "A tournament format — 32 traders, 8 groups of 4, a round-robin group stage in Week 1 followed by 4 weekly knockout rounds (R16, QF, SF, Final). Total tournament duration is 5 weeks. Money is paid at every qualifying stage, not just the final podium." },
      { q: "How do I qualify for the knockouts?",
        a: "In Week 1, you play 3 matches against the other 3 traders in your group (round-robin). The top 2 from each group by record (W-D-L, then equity tiebreaker) advance to the Round of 16." },
      ...
      { q: "How long is each match?",
        a: "Group stage matches are 4 hours each (typically 3 matches across the first week). Knockout matches are also 4 hours each — single match, no replays, win-or-out." },
      ...
      { q: "What's a 3rd-place playoff?",
        a: "After the two Semi-Final matches, the two losing semi-finalists play a 3rd-place playoff. Both still earn the SF qualifier share — the 3rd place playoff is for bragging rights and ranking points (no extra cash prize)." },
      { q: "Can I see other matches in my tournament?",
        a: "Yes. Tournament view shows live equity for every match in progress. Strategically, watching your prospective next opponent is a real edge — you can scout playing styles, position bias, and risk patterns." },
    ],
  },
  {
    id: "tagteam",
