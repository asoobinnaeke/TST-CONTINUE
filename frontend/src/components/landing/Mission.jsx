      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 grid md:grid-cols-2 gap-8">
            <div className="bg-[#16161D] rounded-2xl border border-white/10 p-7" data-testid="mission-card">
              <div className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-[0.18em] text-white bg-[#B4E04C]/15 rounded-full px-3 py-1">
                Mission
              </div>
              <p className="mt-4 text-[15px] text-white/85 leading-relaxed">
                ...
                <span className="font-semibold text-white">more avenues to earn from their skill</span>{" "}
                so the only thing they ever have to beat is another trader.
              </p>
            </div>
            <div className="bg-[#16161D] rounded-2xl border border-white/10 p-7" data-testid="vision-card">
              ...
              <p className="mt-4 text-[15px] text-white/85 leading-relaxed">
                ...
                <span className="font-semibold text-white">visible, verifiable, and directly rewarded</span>, and where every trader has a fair shot at earning without the house tilting the table.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-20 max-w-4xl mx-auto text-center">
          <blockquote className="text-3xl md:text-5xl font-bold tracking-tight text-white leading-[1.1]">
