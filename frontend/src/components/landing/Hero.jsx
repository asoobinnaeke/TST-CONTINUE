...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] -translate-y-1/3 translate-x-1/4 bg-[#A78BFA]/15 rounded-full blur-[120px] opacity-50 pointer-events-none" />
      <div className="absolute top-1/2 left-0 w-[500px] h-[500px] -translate-y-1/2 -translate-x-1/3 bg-[#B4E04C]/15 rounded-full blur-[120px] opacity-40 pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-5 lg:px-8 grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-6 animate-fade-up">
          <a
            href="#products"
            className="inline-flex items-center gap-2 bg-[#16161D] border border-white/10 rounded-full pl-1 pr-4 py-1 text-sm font-medium text-white/85 hover:bg-[#0B0B0F] transition-colors"
          ...
          <h1
            ...
            className="mt-6 text-[44px] sm:text-6xl lg:text-[72px] leading-[1.02] tracking-[-0.02em] font-bold text-white"
          >
            Trade against{" "}
          ...
          <p className="mt-4 max-w-xl text-lg text-white/65 leading-relaxed" data-testid="hero-subhead">
            ...
            <span className="font-semibold text-white">the house is the trap.</span>
          </p>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            ...
            >
              Start competing
              <span className="grid place-items-center w-5 h-5 bg-[#B4E04C] rounded-full text-white">
            ...
            <button
              ...
              className="group inline-flex items-center gap-2 bg-[#16161D] border border-white/10 text-white font-medium text-[15px] px-6 py-3.5 rounded-full hover:bg-[#0B0B0F] transition-all"
            >
          ...
          <div className="mt-12 flex items-center gap-6">
            <div className="flex -space-x-2">
              {["F", "K", "M", "S"].map((c, i) => (
                <span
                  key={i}
                  className="w-9 h-9 rounded-full ring-2 ring-[#0F0F12] grid place-items-center text-xs font-bold text-white"
            ...
            <div>
              ...
              <div className="text-xs text-white/45">$2.1M paid out · 47 countries</div>
            </div>
          </div>
        </div>
        ...
        >
          <div className="relative">
            ...
            <div className="relative bg-[#16161D] border border-white/10 rounded-3xl p-5 lg:p-6 shadow-[0_24px_64px_-24px_rgba(0,0,0,0.6)]">
              {/* header */}
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-[#0B0B0F] grid place-items-center overflow-hidden">
                    <img src={ICON_PURPLE} alt="" className="w-full h-full object-cover" />
                  </div>
                  <div>
                    <div className="text-xs font-mono text-white/45">Duel · #4781</div>
                    <div className="text-sm font-semibold text-white">$100,000 Account</div>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-xs font-mono text-white/45">Time left</div>
                  <div className="font-mono text-base font-semibold text-white">03:42:11</div>
                </div>
              </div>

              {/* chart */}
              <div className="mt-5 h-44 rounded-2xl bg-[#0F0F12] border border-white/5 p-3">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="rounded-2xl border border-white/10 p-3.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[13px] font-medium text-white">@TradeFury</span>
                  </div>
                ...
                <div className="rounded-2xl border border-white/10 p-3.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[13px] font-medium text-white">@GoldHands</span>
                  </div>
              ...
              <div className="mt-4 flex items-center justify-between border-t border-white/5 pt-4">
                ...
                <button className="inline-flex items-center gap-1 text-xs font-medium text-white hover:gap-2 transition-all">
            ...
            {/* floating stat */}
            <div className="hidden md:flex absolute -left-6 bottom-10 items-center gap-3 bg-[#16161D] border border-white/10 rounded-2xl px-4 py-3 shadow-[0_12px_24px_-8px_rgba(0,0,0,0.5)]">
              <div className="w-9 h-9 rounded-xl bg-[#B4E04C]/15 grid place-items-center">
                <Up className="w-4 h-4 text-white" strokeWidth={2.5} />
              </div>
              <div>
                <div className="text-xs text-white/45 font-medium">Avg. winner ROI</div>
                <div className="font-mono text-base font-semibold text-white">+18.4%</div>
              </div>
            </div>
          </div>
        </div>
